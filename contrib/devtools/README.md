...
bitcoingreen-project/bitcoingreen repository.
...
Setup
---------
Configuring the github-merge tool for the bitcoingreen repository is done in the following way:

    git config githubmerge.repository bitcoingreen-project/bitcoingreen
...
A script to optimize png files in the bitcoingreen
