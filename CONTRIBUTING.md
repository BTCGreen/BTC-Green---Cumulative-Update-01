Contributing to bitcoingreen Core
============================

The bitcoingreen Core project operates an open contributor model where anyone is
...
The following applies to code changes to the bitcoingreen Core project, and is not to be
confused with overall bitcoingreen Network Protocol consensus changes.

Whether a pull request is merged into bitcoingreen Core rests with the project merge
...
Patches that change bitcoingreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitcoingreen consensus, it must have been
...
The project leader is the release manager for each bitcoingreen Core release.
