                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinGreen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&bitcoingreen Project"), this);
    webmainAction->setStatusTip(tr("bitcoingreen Project Website"));
    ...
    facebookAction->setStatusTip(tr("bitcoingreen Facebook"));
    ...
    twitterAction->setStatusTip(tr("bitcoingreen Twitter"));
    ...
    discordAction->setStatusTip(tr("bitcoingreen Discord"));
    ...
    youtubeAction->setStatusTip(tr("bitcoingreen Youtube"));
    ...
    telegramAction->setStatusTip(tr("bitcoingreen Telegram"));
    ...
    redditAction->setStatusTip(tr("bitcoingreen Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap bitcoingreen"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell bitcoingreen Coin (bitcoingreen)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    bitcoingreenBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&bitcoingreen block explorer"), this);
    bitcoingreenBlockExplorerAction->setStatusTip(tr("bitcoingreen blockchain explorer"));
    bitcoingreenBlockExplorerAction->setToolTip(bitcoingreenBlockExplorerAction->statusTip());
    bitcoingreenBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&bitcoingreen Project Github"), this);
    githubAction->setStatusTip(tr("bitcoingreen Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bitcoingreen address"));
...
//    }
    ...
    connect(bitcoingreenBlockExplorerAction, SIGNAL(triggered()), this, SLOT(bitcoingreenBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About bitcoingreen Core"), this);
    aboutAction->setStatusTip(tr("Show information about bitcoingreen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bitcoingreen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bitcoingreen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bitcoingreen addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the bitcoingreen Core help message to get a list with possible bitcoingreen command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(bitcoingreenBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("bitcoingreen Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.bitcoingreen.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/bitcoingreen.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/bitcoingreen4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/bitcoingreencryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/bitcoingreen-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::bitcoingreenBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/bitcoingreen/bitcoingreen/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bitcoingreen network", "", count));
}
...
{
    QString strTitle = tr("bitcoingreen Core"); // default title
