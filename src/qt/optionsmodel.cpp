...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::bitcoingreen);
    ...
    if (!settings.contains("nAnonymizebitcoingreenAmount"))
        settings.setValue("nAnonymizebitcoingreenAmount", 1000);

    nAnonymizebitcoingreenAmount = settings.value("nAnonymizebitcoingreenAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizebitcoingreenAmount"))
        SoftSetArg("-anonymizebitcoingreenamount", settings.value("nAnonymizebitcoingreenAmount").toString().toStdString());
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizebitcoingreenAmount:
            return QVariant(nAnonymizebitcoingreenAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizebitcoingreenAmount:
            nAnonymizebitcoingreenAmount = value.toInt();
            settings.setValue("nAnonymizebitcoingreenAmount", nAnonymizebitcoingreenAmount);
            emit anonymizebitcoingreenAmountChanged(nAnonymizebitcoingreenAmount);
            break;
        case CoinControlFeatures:
