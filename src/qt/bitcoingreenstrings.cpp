...
QT_TRANSLATE_NOOP("bitcoingreen-core", " mints deleted\n"),
QT_TRANSLATE_NOOP("bitcoingreen-core", " mints updated, "),
QT_TRANSLATE_NOOP("bitcoingreen-core", " unconfirmed transactions removed\n"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Cannot obtain a lock on data directory %s. bitcoingreen Core is probably already "
"running."),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
...
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Disable all bitcoingreen specific functionality (Masternodes, Zerocoin, SwiftX, "
...
"default: %u)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Enable or disable staking functionality for bitcoingreen inputs (0-1, default: %u)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
...
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Fees (in bitcoingreen/Kb) smaller than this are considered zero fee for relaying "
"(default: %s)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Fees (in bitcoingreen/Kb) smaller than this are considered zero fee for transaction "
"creation (default: %s)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
...
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Unable to bind to %s on this computer. bitcoingreen Core is probably already running."),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Unable to locate enough Obfuscation denominated funds for this transaction."),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
"Unable to locate enough Obfuscation non-denominated funds for this "
"transaction that are not equal 10000 bitcoingreen."),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
...
"your clock is wrong bitcoingreen Core will not work properly."),
QT_TRANSLATE_NOOP("bitcoingreen-core", ""
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "(51472 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "(default: %s)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "(default: 1)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "(must be 51472 for mainnet)"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Calculating missing accumulators..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Can't denominate: no compatible inputs left."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Can't find random Masternode."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Can't mix while sync in progress."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "CoinSpend: Accumulator witness does not verify"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Copyright (C) 2015-%i The bitcoingreen Core Developers"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Enable automatic Zerocoin minting (0-1, default: %u)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Enable publish hash transaction (locked via SwiftX) in <address>"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Enable publish raw transaction (locked via SwiftX) in <address>"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error loading wallet.dat: Wallet requires newer version of bitcoingreen Core"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error writing zerocoinDB to disk"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error: Can't select current denominated inputs"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error: No valid utxo!"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Error: You already have pending entries in the Obfuscation pool"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to calculate accumulator checkpoint"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to create mint"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to deserialize"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to find Zerocoins in wallet.dat"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to read block"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to select a zerocoin"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to wipe zerocoinDB"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Failed to write coin serial number into wallet"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Fee (in bitcoingreen/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Initialization sanity check failed. bitcoingreen Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Last Obfuscation was too recent."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Last successful Obfuscation action was too recent."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Lookup(): Invalid -proxy address or hostname: '%s'"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Mint did not make it into blockchain"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Need address because change is not exact"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "No funds detected in need of denominating."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "No matching denominations found for mixing."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Number of custom location backups to retain (default: %d)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Obfuscation is idle."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Obfuscation request complete:"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Obfuscation request incomplete:"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Percentage of automatically minted Zerocoin  (1-100, default: %u)"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Reindex the bitcoingreen and zECA money supply statistics"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Reindex the accumulator database"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Reindexing zerocoin database..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Reindexing zerocoin failed"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "ResetMintZerocoin finished: "),
QT_TRANSLATE_NOOP("bitcoingreen-core", "ResetSpentZerocoin finished: "),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Selected coins value is less than payment target"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Spend Valid"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "SwiftX options:"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Syncing zECA wallet..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "The coin spend has been used"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "The new spend coin transaction did not verify"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "The selected mint coin is an invalid coin"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "The transaction did not verify"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Too many spends needed"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Transaction Created"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Transaction Mint Started"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Try to spend with a higher security level to include more coins"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Trying to spend an already spent serial #, try again."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Unable to find transaction containing mint"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Unable to sign spork message, wrong key?"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Unable to start HTTP server. See debug log for details."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Value is below the smallest available denomination (= 1) of zECA"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Value more than Obfuscation pool maximum allows."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Verifying wallet..."),
QT_TRANSLATE_NOOP("bitcoingreen-core", "Version 1 zECA require a security level of 100 to successfully spend."),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Wallet needed to be rewritten: restart bitcoingreen Core to complete"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "You don't have enough Zerocoins in your wallet"),
...
QT_TRANSLATE_NOOP("bitcoingreen-core", "Zerocoin options:"),
QT_TRANSLATE_NOOP("bitcoingreen-core", "isValid(): Invalid -proxy address or hostname: '%s'"),
