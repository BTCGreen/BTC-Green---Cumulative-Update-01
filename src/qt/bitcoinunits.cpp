...
QString BitcoinUnits::id(int unit)
{
    ...
    case bitcoingreen:
        return QString("GBTC");
    case mECA:
        return QString("mbitcoingreen");
    case uECA:
        return QString::fromUtf8("ubitcoingreen");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case bitcoingreen:
            return QString("GBTC");
        case mECA:
            return QString("Milli-bitcoingreen (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-bitcoingreen (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
