...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::bitcoingreen, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            ...
            QMessageBox::warning(this, "bitcoingreen Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
