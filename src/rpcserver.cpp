...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bitcoingreen", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoingreen", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoingreen", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"bitcoingreen", "getpoolinfo", &getpoolinfo, true, true, false},
