...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "bitcoingreen is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1617226545;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 1640831;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x12a906c56a34966490ed68e9f9a2c514d513b2049a006a242171d98b746abbf7"));
        assert(hashGenesisBlock == uint256("0x0000009c36fc94064ba0202305ba77602658782f77cbea69030509fe2433c1a2"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x12a906c56a34966490ed68e9f9a2c514d513b2049a006a242171d98b746abbf7"));
        assert(hashGenesisBlock == uint256("0x00001726d92cc0a07ee38c933792bdb359a08d7c6954aead5b70217dc4e7c488"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x12a906c56a34966490ed68e9f9a2c514d513b2049a006a242171d98b746abbf7"));
        assert(hashGenesisBlock == uint256("0x1d1f22d653af0da217608743d287fd74379f40acbebdbe2ee47a8a5ff63aace4"));
